  ...
  loadSource() {
    return new Promise((success, failure) => {
      ...
      .then((htmlText) => {
        ...
        if (animeInfo != null) {
          // Getting info link
          animeInfoLink = GoGoAnime + animeInfo.childNodes[3].attributes.href;
        ...
        if (nextPrev != null) {       
          ...
          if (prev != null) prev = GoGoAnime + prev.attributes.href;
          if (next != null) next = GoGoAnime + next.attributes.href;
        }
