    ...
    if (this.isLastest) {
      ...
      return (
        <View style={{flex: 1, width: width / 4 - 8, padding: 4, margin: 0}}>
          <Button title={this.episode} backgroundColor={Colour.GoGoAnimeRed} 
            buttonStyle={WindowsButtonStyles.buttonStyle} onPress={this.WatchAnime}/>
        </View>
      )
    } else {
      return (
        <View style={{flex: 1, width: width / 4 - 8, padding: 4, margin: 0}}>
          <Button title={this.episode} backgroundColor={Colour.GoGoAnimeOrange} 
            buttonStyle={WindowsButtonStyles.buttonStyle} onPress={this.WatchAnime}/>
        </View>
      )
    }
