...
-(id)init
{
  if(self = [super init]) {
    ...
    [windowController setWindowFrameAutosaveName:@"GoGoAnime_Mac"];
...
- (void)setUpApplicationMenu
{
  ...
  [rootMenu addItemWithTitle:@"Quit GoGoAnime_Mac" action:@selector(terminate:) keyEquivalent:@"q"];
